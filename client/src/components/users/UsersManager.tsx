...
const UsersManager = () => {
  ...
  const fetchUsers = async (signal: AbortSignal) => {
    try {
      const user_res = await getAllUsers(signal);
      if (user_res?.data) {
